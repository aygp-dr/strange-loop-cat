...
#+NAME: module-loading
#+begin_src scheme :tangle "../src/generated/basics-module.scm"
...
Let's put everything together in a complete example that demonstrates tangling:
